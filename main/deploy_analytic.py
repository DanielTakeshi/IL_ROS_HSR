...
# Grasping and success. (Success should probably be the neural network...)
...
class BedMaker():
    ...
    def __init__(self):
        """For deploying a corner-detection heuristic, `Analytic_Grasp`."""
        ...
        # Policy for _analytic_ grasping, and success network.
    ...
    def bed_make(self):
        """Runs pipeline for bed-making using analytic grasping baselines."""
        self.rollout_stats = []
        ...
        while True:
            ...
            if (not c_img == None and not d_img == None):
                ...
                # CHANGE HERE, grasp_factor resizes image.
                grasp_factor = 3
