...
if __name__ == '__main__':
    ...
    people = ['chris_n1','anne_n1','carolyn_n1','chris_n2','anne_n2','carolyn_n2','carolyn_n0','anne_n0','matt_n0','chris_n0']
    ...
    for trial in people: 
        ...
        for traj in data:
            ...
            success_rate = success_rate + float(success_state['success'])
            N = len(traj)
            for i in range(N-1): 
                state = traj[i]
